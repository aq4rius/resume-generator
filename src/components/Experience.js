    ...
    return (
      <div className="experience" id="">
        ...
        <div id="added-experience">
          <AddedExperience
            allExperience={this.state.allExperience}
        ...
        <form onSubmit={this.onSubmitExperience}>
          <div>
            <div>
              ...
              <input
                type="text"
                value={this.state.experience.company.text}
            ...
            <div>
              ...
              <input
                type="text"
                value={this.state.experience.position.text}
          ...
          <div>
            <div>
              ...
              <input
                className="date"
                type="date"
                value={this.state.experience.dateFrom.text}
            ...
            <div>
              ...
              <input
                className="date"
                type="date"
                value={this.state.experience.dateTo.text}
          ...
          <div>
            <div>
              ...
              <textarea
                type="text"
                value={this.state.experience.tasks.text}
